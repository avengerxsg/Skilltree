...
nc || (nc = {}), nc.bns || (nc.bns = {}), nc.bns.training || (nc.bns.training = {}),
    function($) {
        nc.bns.training.util = {}, nc.bns.training.util.StringUtil = {
            ...
            function i(a) {
                nc.bns.training.Model.editable && (s.css("cursor", "auto"), s.unbind("mouseover", j), s.unbind("mouseout", j), s.unbind("mousedown", j), s.unbind("touchend", j), s.unbind("click", j), s.unbind("contextmenu", j), a && (s.css("cursor", "pointer"), s.bind("mouseover", j), s.bind("mouseout", j), s.bind("mousedown", j), s.bind("touchend", j), s.bind("click", j), s.bind("contextmenu", j)))
            }
